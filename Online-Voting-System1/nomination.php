  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse
    ...
    <div class="container" style="padding:100px;">
      <div class="row">
        ...
        <div class="col-sm-3">
          <img src="images/jagan.jpg" class="img img-thumbnail" style="width:200px;height:200px;" alt="">
          <h4 class="normalFont text-center">YS Jagan Mohan Reddy</h4>
          <h5 class="text-center normalFont">Ys Jagan Mohan Reddy is an Telugu politician, who is the Second and current CM of Andhra Pradesh.</h5>
          <hr>
          <ul class="text-left">
            <li>Born: August 16, 1968 (age 46), Siwani</li>
           
          </ul>
        </div>
        <div class="col-sm-3">
          <img src="images/pk.jpg" class="img img-thumbnail" style="width:200px;height:200px;" alt="">
          <h4 class="normalFont text-center">Pavan Kalyan</h4>
          <h5 class="normalFont text-center">Pavan Kalyan is an Indian politician.</h5>
          <hr>
          <ul class="text-left normalFont">
            <li>Born: Sept 22, 1965 (age 50),</li>
