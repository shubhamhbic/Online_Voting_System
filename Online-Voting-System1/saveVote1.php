    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('config.php');
					...
					if(isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["aadhar"]) && isset($_POST["voterID"]) && isset($_POST["selectedCandidate"]))
					{
       ...
       $DB_NAME="db_evoting1";
        ...
        $sql = "update tbl_users set voterName='$name', voterEmail='$email', aadhar='$aadhar', voterID='$voterID', selectedCandidate='$selection' where id='$id'";
        $result = $conn->query($sql);
					

				if(mysqli_query($conn, $sql)){
					echo "<img src='images/success.png' width='70' height='70'>";
					echo "<h3 class='text-info specialHead text-center'><strong> YOU'VE  SUCCESSFULLY   UPDATED.</strong></h3>";
