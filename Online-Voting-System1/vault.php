      ...
      <div class="row">
        <div class="col-sm-12" style="border:2px solid gray;">
          ...
          <div class="form-group">
            ...
            <input type="number" name="aadhar" placeholder="Enter Your Aadhar ID" class="form-control" required><br>

            <button type="submit" name="" style="background-color:#337AB7"><a href="aadhar.php" target="_blank" style="color:white;">Validate</a></button>
            ...
            <div class="radio">
              ...
              <label for="">
                <input type="radio" name="selectedCandidate" value="AAP"> <strong>Aam Aadmi Party (AAP)</strong>
              </label><br>

              <label for="">
                <input type="radio" name="selectedCandidate" value=""> <strong>Trinamool Congress (TMC)</strong>
              </label><br>
              <br>
              <hr>
